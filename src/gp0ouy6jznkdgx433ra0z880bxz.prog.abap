...
*      Field: RECORD Data record number.
    ...
    METHODS
      FORMULA__18_1
        ...
        EXPORTING
          RESULT                   type _ty_s_TG_1-/BIC/MD_EXAM.
...
*       Step ID: '1', Type: 'FORMULA'.
      ...
      CALL METHOD me->FORMULA__18_1
        EXPORTING
          SOURCE_FIELDS             = <_ys_SC_1>
        IMPORTING
          RESULT                    = _G_1-/BIC/MD_EXAM.
*       Step ID: '2', Type: 'DIRECT'.
            _curr_rule-stepid = '2'.
    _G_1-/BIC/MD_CURRN = <_ys_SC_1>-/BIC/MD_CURRN.
          ENDIF.  "suppressed RULE
...
*       Step ID: '1', Type: 'FORMULA'.
      ...
      CLEAR: sy-msgid, sy-msgty, sy-msgno, sy-msgv1, sy-msgv2, sy-msgv3, sy-msgv4.
      CALL METHOD me->FORMULA__21_1
        EXPORTING
          SOURCE_FIELDS             = <_ys_SC_1>
        IMPORTING
          RESULT                    = _G_1-/BIC/MD_UNPR.
*       Step ID: '2', Type: 'DIRECT'.
            _curr_rule-stepid = '2'.
    _G_1-/BIC/MD_CURRN = <_ys_SC_1>-/BIC/MD_CURRN.
          ENDIF.  "suppressed RULE
...
*       Step ID: '1', Type: 'FORMULA'.
      ...
      CLEAR: sy-msgid, sy-msgty, sy-msgno, sy-msgv1, sy-msgv2, sy-msgv3, sy-msgv4.
      CALL METHOD me->FORMULA__23_1
        EXPORTING
          SOURCE_FIELDS             = <_ys_SC_1>
        IMPORTING
          RESULT                    = _G_1-/BIC/MD_PRST.
*       Step ID: '2', Type: 'DIRECT'.
            _curr_rule-stepid = '2'.
    _G_1-/BIC/MD_CURRN = <_ys_SC_1>-/BIC/MD_CURRN.
          ENDIF.  "suppressed RULE
...
BEGIN OF _RSSG_C_PDIR,
  UNI_IDC25 TYPE  RSSGTPDIR-UNI_IDC25
    VALUE '0OUY6JZNKDGX433RA0Z880BXZ',
