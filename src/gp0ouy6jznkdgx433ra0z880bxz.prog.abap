...
* Object reference   0OUY6JZNKDGX433RA0Z880BXZ
***********************************************************************
...
*
*   Template......: RSTRAN_MASTER_TMPL
*   TranID........: 0TV24F1JY884H1C30RDIC36ST131L5UT   Version: 0
*   Source........: ODSO TD_IS
*   Target........: CUBE TD_IS_C
*
*   Author........: DUMMY
...
IMPORTING
        ...
        EXPORTING
          result                   TYPE _ty_s_tg_1-/bic/md_exam. "insert your code here
...
IMPORTING
          source_fields              TYPE _ty_s_sc_1
        EXPORTING
          result                   TYPE _ty_s_tg_1-/bic/md_unpr.
...
IMPORTING
          source_fields              TYPE _ty_s_sc_1
        EXPORTING
          result                   TYPE _ty_s_tg_1-/bic/md_prst.
...
*   get transformation target list and set in segment
    ...
    _curr_rule-tranid  = '0TV24F1JY884H1C30RDIC36ST131L5UT'.
    _curr_rule-progid  = '0OUY6JZNKDGX433RA0Z880BXZ'.
...
*       Step ID: '2', Type: 'CONVERT'.
          ...
          ID 'OUTPUT' FIELD _g_1-/bic/md_son.
            ...
            IF _g_1-/bic/md_son <> _r_9-_1_1.
              cl_rstran_runtime_exe=>data_error( EXPORTING i_r_log = i_r_log i_rule_context = _curr_rule i_in = _r_9-_1_1 i_out = _g_1-/bic/md_son EXCEPTIONS too_many_errors = 1 ).
              IF sy-subrc = 1.
...
*       Step ID: '1', Type: 'DIRECT'.
            _curr_rule-stepid = '1'.
            _r_11-_1_1 = <_ys_sc_1>-/bic/md_sf.
*       Step ID: '2', Type: 'CONVERT'.
            _curr_rule-stepid = '2'.
            CALL 'CONVERSION_EXIT_ALPHA_INPUT'
          ID 'INPUT'  FIELD _r_11-_1_1
          ID 'OUTPUT' FIELD _g_1-/bic/md_sf.

            IF _g_1-/bic/md_sf <> _r_11-_1_1.
              cl_rstran_runtime_exe=>data_error( EXPORTING i_r_log = i_r_log i_rule_context = _curr_rule i_in = _r_11-_1_1 i_out = _g_1-/bic/md_sf EXCEPTIONS too_many_errors = 1 ).
              IF sy-subrc = 1.
                RAISE EXCEPTION TYPE cx_rsrout_abort.
              ENDIF.
...
*       Step ID: '1', Type: 'DIRECT'.
            _curr_rule-stepid = '1'.
            _g_1-/bic/md_cus = <_ys_sc_1>-/bic/md_cus.
          ENDIF.  "suppressed RULE
*>>>
*<<<    Rule ID: '15'.
...
*       Step ID: '1', Type: 'DIRECT'.
            _curr_rule-stepid = '1'.
            _r_16-_1_1 = <_ys_sc_1>-/bic/md_frg.
*       Step ID: '2', Type: 'CONVERT'.
            _curr_rule-stepid = '2'.
            CALL 'CONVERSION_EXIT_ALPHA_INPUT'
          ID 'INPUT'  FIELD _r_16-_1_1
          ID 'OUTPUT' FIELD _g_1-/bic/md_frg.

            IF _g_1-/bic/md_frg <> _r_16-_1_1.
              cl_rstran_runtime_exe=>data_error( EXPORTING i_r_log = i_r_log i_rule_context = _curr_rule i_in = _r_16-_1_1 i_out = _g_1-/bic/md_frg EXCEPTIONS too_many_errors = 1 ).
              IF sy-subrc = 1.
                RAISE EXCEPTION TYPE cx_rsrout_abort.
              ENDIF.
...
*       Step ID: '1', Type: 'FORMULA'.
            ...
            formula__18_1( EXPORTING source_fields = <_ys_sc_1> IMPORTING result = _g_1-/bic/md_exam ).
*       Step ID: '2', Type: 'DIRECT'.
            _curr_rule-stepid = '2'.
            _g_1-/bic/md_currn = <_ys_sc_1>-/bic/md_currn.
          ENDIF.  "suppressed RULE
...
*       Step ID: '1', Type: 'ROUTINE'.
            ...
            TRY.
                compute_19_1( EXPORTING request = l_request datapackid = i_r_inbound->n_datapakid source_fields = <_ys_sc_1> segid = l_segid IMPORTING result = _g_1-/bic/md_gpf monitor = _lt_msg ).
...
*       Step ID: '1', Type: 'ROUTINE'.
            ...
            TRY.
                compute_20_1( EXPORTING request = l_request datapackid = i_r_inbound->n_datapakid source_fields = <_ys_sc_1> segid = l_segid IMPORTING result = _g_1-/bic/md_npf monitor = _lt_msg ).
...
*       Step ID: '1', Type: 'FORMULA'.
            ...
            CLEAR: sy-msgid, sy-msgty, sy-msgno, sy-msgv1, sy-msgv2, sy-msgv3, sy-msgv4.
            formula__21_1( EXPORTING source_fields = <_ys_sc_1> IMPORTING result = _g_1-/bic/md_unpr ).
*       Step ID: '2', Type: 'DIRECT'.
            _curr_rule-stepid = '2'.
            _g_1-/bic/md_currn = <_ys_sc_1>-/bic/md_currn.
          ENDIF.  "suppressed RULE
...
*       Step ID: '1', Type: 'FORMULA'.
            ...
            CLEAR: sy-msgid, sy-msgty, sy-msgno, sy-msgv1, sy-msgv2, sy-msgv3, sy-msgv4.
            formula__23_1( EXPORTING source_fields = <_ys_sc_1> IMPORTING result = _g_1-/bic/md_prst ).
*       Step ID: '2', Type: 'DIRECT'.
            _curr_rule-stepid = '2'.
            _g_1-/bic/md_currn = <_ys_sc_1>-/bic/md_currn.
          ENDIF.  "suppressed RULE
...
*       Step ID: '1', Type: 'FORMULA'.
            ...
            CLEAR: sy-msgid, sy-msgty, sy-msgno, sy-msgv1, sy-msgv2, sy-msgv3, sy-msgv4.
            formula__22_1( EXPORTING source_fields = <_ys_sc_1> IMPORTING result = _g_1-/bic/md_disper ).
          ENDIF.  "suppressed RULE
*>>>
*<<<    Rule ID: '24'.
...
*Calculation:
    l_arg1  = source_fields-/bic/md_sa + source_fields-/bic/md_da.
    result = l_arg1.
  ENDMETHOD.                    "FORMULA__18_1
...
*    raise exception type CX_RSROUT_SKIP_VAL.
     ...
     " Calculate Gross Profit Amount (/BIC/MD_GPF)
"Formula: Net Sales (/BIC/MD_SA) + Discount (/BIC/MD_DA) - COGS
"(/BIC/MD_TPC)
    result = source_fields-/bic/md_sa + source_fields-/bic/md_da -
     source_fields-/bic/md_tpc.


  ENDMETHOD.                    "compute_19_1
  METHOD invert_19_1.
...
*     SOURCE_FIELDS-/BIC/MD_TPC TYPE /BIC/OIMD_TPC
*     SOURCE_FIELDS-/BIC/MD_SA TYPE /BIC/OIMD_SA
*     SOURCE_FIELDS-/BIC/MD_TA TYPE /BIC/OIMD_TA
*    EXPORTING
*      RESULT type _ty_s_TG_1-/BIC/MD_NPF
...
*    raise exception type CX_RSROUT_SKIP_VAL.
     ...
     " Calculate the Net Profit Amount (/BIC/MD_NPF)
     " Formula: Net Sales + Discount - COGS - Tax
    result = source_fields-/bic/md_sa + source_fields-/bic/md_da -
     source_fields-/bic/md_tpc - source_fields-/bic/md_ta.


  ENDMETHOD.                    "compute_20_1
  METHOD invert_20_1.
...
*$*$ end of inverse routine - insert your code only before this line *-*
  ...
  ENDMETHOD.                    "invert_20_1

  METHOD formula__21_1.
******************************************************
*This ABAP Code was generated automatically          *
*Formula Calculator                                  *
******************************************************
...
*Calculation:
    l_arg1  = source_fields-/bic/md_sa + source_fields-/bic/md_da.
    l_arg2  = l_arg1  / source_fields-/bic/md_oq.
    result = l_arg2.
  ENDMETHOD.                    "FORMULA__21_1

  METHOD formula__23_1.
******************************************************
*This ABAP Code was generated automatically          *
*Formula Calculator                                  *
******************************************************
...
*Data definition:
    DATA: l_arg1  TYPE f.
*Calculation:
    l_arg1  = source_fields-/bic/md_tpc / source_fields-/bic/md_oq.
    result = l_arg1.
  ENDMETHOD.                    "FORMULA__23_1

  METHOD formula__22_1.
******************************************************
*This ABAP Code was generated automatically          *
*Formula Calculator                                  *
******************************************************
...
*Data definition:
    ...
    DATA: l_arg3  TYPE p LENGTH 16 DECIMALS 2.
    DATA: l_arg4  TYPE f.
    DATA: l_arg5  TYPE f.
*Calculation:
    l_arg2  = source_fields-/bic/md_da + source_fields-/bic/md_sa.
    IF ( l_arg2  NE 0 ).
      l_arg3  = source_fields-/bic/md_da + source_fields-/bic/md_sa.
      l_arg4  = source_fields-/bic/md_da / l_arg3.
      l_arg5  = l_arg4  * 100.
      ASSIGN l_arg5 TO <l_ref1>.
    ELSE.
      ASSIGN 0 TO <l_ref1>.
    ENDIF.
    result = <l_ref1>.
  ENDMETHOD.                    "FORMULA__22_1
